...
In order for this theme to work properly, maek sure to set the background color to white and the background opacity to 100% in appearnce settings, and check the box next to "Use skin translucency if supported"
